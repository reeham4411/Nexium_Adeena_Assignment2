        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold">BlogSummarize</h3>
                <p className="text-sm text-gray-400">AI-Powered Translation</p>
              </div>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Transform lengthy blog posts into concise summaries with seamless
              Urdu translation. Powered by cutting-edge AI technology for
